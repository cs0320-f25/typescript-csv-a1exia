...
test("parseCSV testing a schema", () => __awaiter(void 0, void 0, void 0, function* () {
    const students = zod_1.z.tuple([zod_1.z.string(), zod_1.z.coerce.number(), zod_1.z.string().email()]);
    const results = yield (0, basic_parser_1.parseCSV)(STUDENTS_CSV_PATH, students);
